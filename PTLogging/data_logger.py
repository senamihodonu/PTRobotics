...
# Add support for width and pressure data, defaulting to None
width = None
pressure = None
    ...
    if socket_connected and client is not None:
        try:
            ...
            try:
                ...
                # Optionally handle additional sensor data
...
def capture_and_save():
    ...
    db.insert_print_data(
        ...
        layer_height, comment, width, pressure
    )

    log(f"Data saved: {print_tag}, Temp: {temperature}, Humidity: {humidity}, Width: {width}, Pressure: {pressure}, Group: {group_tag}, Comment: {comment}")
