...
z = 0
initial_pose = [-100, 0, z, 0, 90, 0]
utils.woody.write_cartesian_position(initial_pose)
print(f"Robot moved to initial pose: {initial_pose}")
...
initial_pose, z = utils.calibrate_height(initial_pose, LAYER_HEIGHT)
time.sleep(2)
